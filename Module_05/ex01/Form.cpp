...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/27 17:11:41 by pwolff            #+#    #+#             */
/*   Updated: 2022/08/27 17:11:41 by pwolff           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(void) : _name("Form"), _sign(false), _gradeSign(MAXI_GRADE), _gradeExec(MAXI_GRADE)
{
...
Form::Form(std::string name, int gradeSign, int gradeExec) : _name(name), _sign(false), _gradeSign(MAXI_GRADE), _gradeExec(MAXI_GRADE)
{
	{
...
{
	std::cout << CYANE UNDER " ** Test Bureaucrat::signForm() : " NONE ;
	buro.signForm(*this);
